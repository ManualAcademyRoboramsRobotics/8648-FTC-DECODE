...
public class LocalizerCombinedTuner extends BaseOpMode {
    ...
    final Pose2D Position1 = new Pose2D(DistanceUnit.INCH, 0, 24, AngleUnit.DEGREES, 90);
    final Pose2D Position2 = new Pose2D(DistanceUnit.INCH, 24, 0, AngleUnit.DEGREES, 180);
    final Pose2D Position3 = new Pose2D(DistanceUnit.INCH, 0, -24, AngleUnit.DEGREES, -90);
    final Pose2D Position4 = new Pose2D(DistanceUnit.INCH, -24, 0, AngleUnit.DEGREES, 0);
